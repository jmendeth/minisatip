...
int read_http(sockets * s)
{
	...
	static char *xml =
			"<?xml version=\"1.0\"?>"
					...
					"<modelDescription>dm500-satip-2.3, linux 2.6.28, minisatip 0.4</modelDescription><modelName>dm500-satip-2.3</modelName>"
					"<modelNumber>2.3</modelNumber><modelURL></modelURL><serialNumber>1</serialNumber><UDN>uuid:%s</UDN>"
					"<iconList>"
